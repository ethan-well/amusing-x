...
import (
	...
	"amusingx.fit/amusingx/services/user/authentication"
	"amusingx.fit/amusingx/services/user/mysql/ganymededb/model"
	authentication2 "amusingx.fit/amusingx/services/user/mysql/ganymededb/model/authentication"
	"context"
...
func InitCurrentUser(info *service.UserInfo) {
...
func (u *User) InitUserInfoByID(ctx context.Context, id int64) aerror.Error {
	tx, err := model.UserDB.BeginTxx(ctx, nil)
	if err != nil {
