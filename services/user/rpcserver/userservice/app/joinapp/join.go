...
import (
	...
	"amusingx.fit/amusingx/services/user/xredis/lock"
	"context"
	"fmt"
...
func CreateUser(ctx context.Context, r *service.JoinRequest) (*model.UserComplex, aerror.Error) {
	var (
		err  aerror.Error
...
func clearPassword(r *service.JoinRequest, u *model.UserComplex) {
	r.Password = ""
	u.Password = ""
	u.PasswordDigest = ""
}
