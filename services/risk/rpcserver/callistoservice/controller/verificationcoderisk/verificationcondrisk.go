...
import (
	...
	"amusingx.fit/amusingx/services/risk/rpcserver/callistoservice/model/verificationcontrolmodel"
	"context"
...
func LoginRiskControl(ctx context.Context, req *riskservice.LoginRiskRequest) aerror.Error {
	if req == nil {
		return aerror.NewError(nil, aerror.Code.CParamsErr, "request is nil")
	}
