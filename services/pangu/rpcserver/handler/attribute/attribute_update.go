...
func HandlerAttributeUpdate(ctx context.Context, req *panguservice.AttributeUpdateRequest) *response.CommResponse {
	resp, e := charonclient.Client.AttributeUpdate(ctx, req)
