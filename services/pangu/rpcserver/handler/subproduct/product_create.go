...
func HandlerSubProductCreate(ctx context.Context, req *panguservice.SubProductCreateRequest) *response.CommResponse {
	resp, e := charonclient.Client.SubProductCreate(ctx, req)
