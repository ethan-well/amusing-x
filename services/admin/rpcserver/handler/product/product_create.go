...
func HandlerProductCreate(ctx context.Context, req *panguservice.ProductCreateRequest) *response.CommResponse {
	resp, e := charonclient.Client.ProductCreate(ctx, req)
