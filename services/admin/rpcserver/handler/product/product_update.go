...
func HandlerProductUpdate(ctx context.Context, req *panguservice.ProductUpdateRequest) *response.CommResponse {
	resp, e := charonclient.Client.ProductUpdate(ctx, req)
