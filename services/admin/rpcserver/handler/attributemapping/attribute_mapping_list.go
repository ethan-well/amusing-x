...
func HandlerAttributeMappings(ctx context.Context, req *panguservice.AttributeMappingListRequest) *response.CommResponse {
	resp, e := charonclient.Client.AttributeMappings(ctx, req)
