...
func HandlerAttributeMapping(ctx context.Context, req *panguservice.AttributeMappingRequest) *response.CommResponse {
	resp, e := charonclient.Client.AttributeMapping(ctx, req)
