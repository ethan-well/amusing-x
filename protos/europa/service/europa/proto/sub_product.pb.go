...
type SubProductDetail struct {
	...
	Attributes     []*proto.AttributeWithSubProduct `protobuf:"bytes,2,rep,name=Attributes,proto3" json:"Attributes,omitempty"`
}
...
func (x *SubProductDetail) GetAttributes() []*proto.AttributeWithSubProduct {
	if x != nil {
		return x.Attributes
	}
	return nil
...
var file_europa_proto_sub_product_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x01, 0x0a,
	...
	0x6e, 0x66, 0x6f, 0x12, 0x45, 0x0a, 0x0a, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x70, 0x61, 0x6e, 0x67, 0x75, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x57, 0x69, 0x74, 0x68, 0x53, 0x75, 0x62, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x0a,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x61, 0x6d,
...
var file_europa_proto_sub_product_proto_depIdxs = []int32{
	...
	2, // 1: SubProductDetail.Attributes:type_name -> panguservice.AttributeWithSubProduct
