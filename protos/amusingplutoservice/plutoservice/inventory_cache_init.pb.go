...
type InventoryCacheInitRequest_CacheObjType int32

const (
	InventoryCacheInitRequest_Book InventoryCacheInitRequest_CacheObjType = 0
	InventoryCacheInitRequest_Mac  InventoryCacheInitRequest_CacheObjType = 1
)

// Enum value maps for InventoryCacheInitRequest_CacheObjType.
var (
	InventoryCacheInitRequest_CacheObjType_name = map[int32]string{
		0: "Book",
		1: "Mac",
	}
	InventoryCacheInitRequest_CacheObjType_value = map[string]int32{
		"Book": 0,
		"Mac":  1,
	}
)

func (x InventoryCacheInitRequest_CacheObjType) Enum() *InventoryCacheInitRequest_CacheObjType {
	p := new(InventoryCacheInitRequest_CacheObjType)
	*p = x
	return p
}

func (x InventoryCacheInitRequest_CacheObjType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (InventoryCacheInitRequest_CacheObjType) Descriptor() protoreflect.EnumDescriptor {
	return file_inventory_cache_init_proto_enumTypes[0].Descriptor()
}

func (InventoryCacheInitRequest_CacheObjType) Type() protoreflect.EnumType {
	return &file_inventory_cache_init_proto_enumTypes[0]
}

func (x InventoryCacheInitRequest_CacheObjType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use InventoryCacheInitRequest_CacheObjType.Descriptor instead.
func (InventoryCacheInitRequest_CacheObjType) EnumDescriptor() ([]byte, []int) {
	return file_inventory_cache_init_proto_rawDescGZIP(), []int{0, 0}
}
...
type InventoryCacheInitRequest struct {
	...
	Obj InventoryCacheInitRequest_CacheObjType `protobuf:"varint,1,opt,name=obj,proto3,enum=plutoservice.InventoryCacheInitRequest_CacheObjType" json:"obj,omitempty"`
}
...
func (x *InventoryCacheInitRequest) GetObj() InventoryCacheInitRequest_CacheObjType {
	if x != nil {
		return x.Obj
	}
	return InventoryCacheInitRequest_Book
}
...
var file_inventory_cache_init_proto_rawDesc = []byte{
	...
	,
...
var file_inventory_cache_init_proto_goTypes = []interface{}{
	(InventoryCacheInitRequest_CacheObjType)(0), // 0: plutoservice.InventoryCacheInitRequest.CacheObjType
...
var file_inventory_cache_init_proto_depIdxs = []int32{
	0, // 0: plutoservice.InventoryCacheInitRequest.obj:type_name -> plutoservice.InventoryCacheInitRequest.CacheObjType
